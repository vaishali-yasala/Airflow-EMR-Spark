...
# Configurations
BUCKET_NAME = "vaishali-athena-training"  
local_data = "./dags/data/sales-data.csv"
s3_data = "data/sales-data.csv"
local_script = "./dags/scripts/spark/main.py"
...
# xcom is a way through which communication of variables across different tasks.
